...
#------------------------------------------------------------------------------#
    ...
    def validar_familia(self, elemento, familia):
        ...
        try:
            ...
            familia_tuple = tuple(familia) if isinstance(familia, list) else (familia,)
            info = core.get_Xray_info(elemento, families=familia_tuple, config_anode=self.config.anode)
